...
/**
 * A character stream like java.io.StringWriter that collects its output in a
 * StringBuilder, which can then be used to construct a string.
 * <p>
...
public class StringWriter extends Writer {
	 ...
	 *            builder before it is automatically expanded
	 * 
	 ...
	 * instance, invoking the <tt>toString</tt> method of a character builder
	 * will return a subsequence whose content depends upon the builder's
	 * position and limit.
	 * 
	 * @param csq
